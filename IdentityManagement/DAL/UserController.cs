...
namespace IdentityManagement.DAL
{
    public static class UserController
    {
        public static int NewUser(ApplicationUser objUser)
        {
            ...
            parameters.Add(new ParameterInfo() { ParameterName = "Status", ParameterValue = 1 });
            parameters.Add(new ParameterInfo() { ParameterName = "ImageContent", ParameterValue = objUser.ImageContent1 });
            parameters.Add(new ParameterInfo() { ParameterName = "AttractionName", ParameterValue = objUser.AttractionName });
